...
export default function HowItWorks() {
  return (
    <div className="px-12 py-8 text-gray-900">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between px-12 py-8">
        <div className="flex flex-col justify-center items-center">
          <h3 className="font-inter font-semibold text-2xl "> Step 1</h3>
        ...
        <div className="text-center flex flex-col justify-center items-center">
          <h3 className="text-center font-inter font-semibold text-2xl ">
            Step 2
          </h3>
        ...
        <div className="flex flex-col justify-center items-center">
          <h3 className="font-inter font-semibold text-2xl "> Step 3</h3>
